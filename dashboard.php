...
?>
    ...
    <div id="main-container" class="container-fluid">
        ...
        <p class="section-description">Add or update informations of your movies</p>
        <div class="col-md-12" id="add-movie-container"><a href="<?= $BASE_URL ?>newmovie.php" class="btn card-btn"><i class="fas fa-plus"></i>Add movie</a>
    </div>
